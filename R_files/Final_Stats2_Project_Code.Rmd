...
****************************************
```{r}
custom.log <- glm(y~nr.employed + cons.price.idx + duration + campaign  + contact  + education  + age+ poutcome +duration*contact + duration*job , family = "binomial", data = trainingsData2)
